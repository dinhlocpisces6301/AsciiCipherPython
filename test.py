...
for result in results:
    index += 1
    point = vnchar.check(result.lower()) # Chấm điểm dựa trên nhóm ký tự phổ biến của Tiếng Việt
    if(point > length/5): # Lựa chọn mức độ điểm tương đối, nếu điểm càng cao thì số đề xuất sẽ ít
